 ...
 **/
[System.Serializable]
[UnityEditor.CustomPropertyDrawer(typeof(RangedTooltipAttribute))]
public class RangedTooltipDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        RangedTooltipAttribute range = this.attribute as RangedTooltipAttribute;
        GUIContent content = new GUIContent(label.text, range.text);
